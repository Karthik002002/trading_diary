...
router.post(
	"/",
	strategyValidators_1.createStrategyValidator,
...
router.get("/:id", (req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			const strategy = yield strategy_1.default.findOne({
...
router.put(
	"/:id",
	strategyValidators_1.updateStrategyValidator,
	validateRequest_1.validateRequest,
	(req, res) =>
		__awaiter(void 0, void 0, void 0, function* () {
			try {
...
router.delete("/:id", (req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			const strategy = yield strategy_1.default.findOneAndDelete({
				id: parseInt(req.params.id),
			});
			if (!strategy)
				return res.status(404).json({ message: "Strategy not found" });
