...
// Create new trade
router.post('/', uploadMiddleware_1.upload.single('photo'), tradeValidators_1.createTradeValidator, validateRequest_1.validateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (req.file) {
...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [trades, total] = yield Promise.all([
            trade_1.default.find({}).sort({ createdAt: -1 }).skip(skip).limit(limit),
...
// Update trade
router.put('/:id', uploadMiddleware_1.upload.single('photo'), tradeValidators_1.updateTradeValidator, validateRequest_1.validateRequest, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const trade = yield trade_1.default.findById(req.params.id);
        if (!trade)
            return res.status(404).json({ message: 'Trade not found' });
