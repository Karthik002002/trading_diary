...
exports.createTradeValidator = [
    (0, express_validator_1.body)('strategy_id').isNumeric().withMessage('Strategy ID must be a number'),
    (0, express_validator_1.body)('symbol_id').isNumeric().withMessage('Symbol ID must be a number'),
    ...
    (0, express_validator_1.body)('trade_date').isISO8601().toDate().withMessage('Invalid trade date'),
    (0, express_validator_1.body)('entry_price').isNumeric().withMessage('Entry price must be a number'),
    (0, express_validator_1.body)('exit_price').isNumeric().withMessage('Exit price must be a number'),
    ...
    (0, express_validator_1.body)('entry_reason').notEmpty().withMessage('Entry reason is required'),
    (0, express_validator_1.body)('exit_reason').notEmpty().withMessage('Exit reason is required'),
    (0, express_validator_1.body)('photo').optional().isString().withMessage('Photo must be a string URL or path'),
];
