...
ChromaDB runs as a Docker container and is accessed over HTTP.
"""
...
class TradeRetriever:
    def __init__(self, openai_client: OpenAI, chroma_host: str, chroma_port: int):
        self.openai = openai_client

        # HttpClient connects to ChromaDB running in Docker.
        # The Docker container exposes port 8001 (configured in docker-compose.yml).
