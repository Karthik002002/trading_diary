...
export const createTradeValidator = [
  ...
  body('market_condition')
    ...
    .withMessage('Market condition must be trending, ranging, volatile, or choppy'),
  ...
  body('emotional_state')
    ...
    .withMessage('Emotional state must be calm, anxious, overconfident, fearful, or tilted'),
  body('fees')
    .optional({ nullable: true })
    .isNumeric()
