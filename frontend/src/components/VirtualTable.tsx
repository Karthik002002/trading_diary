							...
							{headerGroup.headers.map((header) => {
								return (
									<th
										...
										className={cn(
											"px-6 py-4 cursor-pointer select-none border-b border-gray-700 text-secondary font-semibold tracking-wider hover:text-white transition-colors !bg-transparent ",
										)}
										...
										<div className="flex items-center space-x-2">
											...
											<span>
												{{
													...
													<FaSort className="text-border hover:text-secondary opacity-50" />
												)}
											</span>
										</div>
									</th>
