...
const ViewTradeModal = ({
	...
	const displaKeyMap: { key: string; value: keyof Trade }[] = [
		{ key: "Strategy", value: "strategy_id" },
		{ key: "Symbol", value: "symbol_id" },
		{ key: "Type", value: "type" },
		{ key: "Quantity", value: "quantity" },
		{ key: "Entry Price", value: "entry_price" },
		{ key: "Exit Price", value: "exit_price" },
		{ key: "P/L", value: "pl" },
	...
	return (
		...
		>
			...
			<div className="flex gap-4">
				<div className="w-1/2">
					{trade.photo && (
						<img src={`${BACKEND_URL}/${trade.photo}`} alt="trade" />
					)}
				</div>
				<div className="w-1/2">
